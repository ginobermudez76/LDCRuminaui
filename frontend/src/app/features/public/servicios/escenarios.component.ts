...
@Component({
    ...
    <div class="servicios-page">
      <div class="page-hero">
        <div class="hero-title-row">
          <span class="material-symbols-outlined hero-icon">stadium</span>
      ...
      <div class="content-wrap">
        <div class="grid-cards" *ngIf="items().length > 0; else empty">
          <div class="escenario-card" *ngFor="let d of items()">
  ...
  styles: [`
    ...
    .escenario-card { background: rgba(255,255,255,0.06); border: 1px solid rgba(15,195,198,0.2); border-radius: 12px; overflow: hidden; transition: all 0.3s; }
    .escenario-card:hover { transform: translateY(-6px); border-color: #0fc3c6; }
