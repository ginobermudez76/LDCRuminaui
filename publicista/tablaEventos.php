...
?>
        ...
        <div id="modalEditEventos" class="modal edit">
        ...
        <script>
            ...
            function openModal() {
                var modal = document.getElementById("modalEditEventos");
            ...
            function loadForm(idEvento) {
                ...
                xhttp.open("GET", "formEditEvento.php?id=" + idEvento, true); // Pasar el ID del deporte en la URL
                xhttp.send();
            }
        </script>
        <script>
